...
class custom_currency extends CModule
{
    ...
    public function __construct()
    {
         ...
         * @var string
         */
        $this->MODULE_NAME = GetMessage('CUSTOM_CURRENCY_MODULE_NAME');
        /**
         * Module description.
         *
         * @var string
         */
        $this->MODULE_DESCRIPTION = GetMessage('CUSTOM_CURRENCY_MODULE_DESC');
        /**
         * Module partner name.
         *
         * @var string
         */
        $this->PARTNER_NAME = GetMessage('CUSTOM_CURRENCY_PARTNER_NAME');
        /**
         * Module partner URI.
         *
         * @var string
